...
class ActionHelloWorld(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        global ven
        ven=vendor_list
        print(ven,"22222222222222222222222222222222222222")
        ...
        # shop_titles = [shop["shop_title"] for shop in all_shops["data"]["vendorCollection"]["allVendors"]]
        ...
        # print(new_dict)
        # print(type(string),"------------type new strinf")
        # if string != 0:
        #         dispatcher.utter_custom_json(new_dict)           
        # else:
        #      dispatcher.utter_message(text="*There* *is* *no* *list* *of* *vendor*\n*Sorry* *for* *inconvenience*")
...
class Actionorderquantity(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        # quntityCheck=data2['items']['qty']
        # print(quntityCheck,"----------->>>>>>---quentity check")
        if quntityCheck1 < 1:
...
class ActionLocationData(Action):
    ...
    def run(self,dispatcher,tracker,domain):
        ...
        try:
            ...
            # dispatcher.utter_message(text='Please enter a mobile number')
        except ValueError:
        ...
        # return[FollowupAction('validate_userDetails_form')]
...
class ActionCheckAuth(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        # dealerid = tracker.get_slot('dealerid')
